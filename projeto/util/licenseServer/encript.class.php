...
protected $IV;
   ...
   if ($this->validateParams()) {
	...
	//return trim(base64_encode(mcrypt_encrypt(MCRYPT_3DES, $this->key, $this->data, $this->mode, $this->getIV())));
	
	
	
	
	//return  base64_encode(mcrypt_encrypt($this->cipher, $this->key, $this->data, $this->mode));
    } else {
